// (function($, undefined){
//   var FieldType = function(name, label) {
//     this.name = name;
//     this.label = label;
//   };
//
//   var FieldTypes = [
//     new FieldType("text", "Single Line Text"),
...
//
//       // Create tab contents
//         addFieldTab = this._createAddFieldTab(),
...
//     },
//
//     _createAddFieldTab: function() {
//       var tab = $("<div>").attr('id', 'tab-1');
//
//       $.each(FieldTypes, function(index, field_type){
//         var button = $("<a>").attr('href', '#').addClass("btn").text(field_type.label);
//         button.appendTo(tab);
//       });
//
//       return tab;
